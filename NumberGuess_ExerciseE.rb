...
class Game
  ...
  def display_instructions
    ...
    puts "you with feedback. You will have 10 chances " 
    puts "to guess the game's secret number.\n\n\n"
    puts "Good luck!\n\n\n\n\n\n\n\n\n"
  ...
  def play_game
    ...
    number = generate_number 
        ...
        loop do
            ...
            if $noOfGuesses == 10
                Console_Screen.cls       #Clear the display area
                puts " You have made " + $noOfGuesses.to_s + " guesses. You lose, press Enter to continue."
                Console_Screen.pause       #Pause the game
                break  #Exit loop
              #Prompt the player to make a guess
            else
                if $answer == "c"
                    puts "cheat: " + number.to_s
                end 
                ...
                Console_Screen.cls       #Clear the display area
                puts "  you entered invalid input"
                puts "  please enter a number between 1 and 1000. Press Enter to continue."
                Console_Screen.pause      #Pause the game
...
if $answer == "n"  #See if the player elected not to take the game
  ...
  loop do
    ...
    $avgNoOfGuesses =  $totalNoOfGuesses.to_f / $gameCount.to_f    
    # output to console
    puts $gameCount.to_s + " game(s) played"
    puts $avgNoOfGuesses.to_s + " average guesses per game"
    $noOfGuesses = 0
