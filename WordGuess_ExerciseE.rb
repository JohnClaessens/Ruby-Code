...
class Game
  ...
  def display_instructions
    ...
    puts "a word that is between 5 and 10 letters long and"
    puts "challenges you to guess it. Before submitting your guess, you"
    puts "must specify 5 consonants and 1 vowel. If any of these"
    ...
    puts "The underscore character indicates a letter that doesn not match"
    puts "any of the 5 consonents or 1 vowel you have chosen and will indicate"
    puts "the length of the word to guess. \n\n"
    puts "Good luck!\n\n\n\n\n\n\n\n\n"
  ...
  def select_word
    ...
    words = ["W I N D O W", "S T A T I O N", "H A M B U R G E R",
             ...
             "H A P P Y","S P O T L E S S","N A T I O N","S P I D E R S",
             "J A G G E D","D R A W E R","B O R D E R","G R A C E F U L",
             "M E D D L E","P L A N T S","B R O K E N","E X P E R I E N C E",
             "D E S E R T E D","F E T C H","A D J U S T M E N T",
             "S T I T C H","S P E L L","R O T T E N",
             "I M P E R F E C T","W R A T H F U L","P L A C I D"]
  ...
  def prompt_for_guess(shortWord, word, consonants, vowel)
    ...
    3.times do |i|  #i equals 0 on the first iteration of the loop
      ...
      if guess.empty? == false then
        puts "so far you have guessed: " + guess.inspect.gsub("\"", "") + "\n\n"
      end     
      ...
      if reply == shortWord then  #The player's guessed the secret word
        ...
        if i == 1 then 
          ...
          print "The word was " + shortWord.downcase.sub(/./,&:upcase) + ". Press Enter to continue."
        else
...
loop do
  ...
  puts "Are you ready to play the Word Guessing Game? (y/n): "
  puts "Press 'h' key for help "
...
if $answer == "n" or $answer == "N" #See if the player elected not
  ...
  loop do  #Loop forever
    ...
    puts "Enter Q to quit or press any key to play again: "
    puts "Press 'h' key for help "
