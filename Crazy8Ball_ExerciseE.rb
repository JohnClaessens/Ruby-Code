...
class Ball
  ...
  def get_fortune
    ...
    case randomNo
      ...
      when 6
        $prediction = "unknown"
      when 7 
        $prediction = "The spirits are a little fuzzy right now"
      when 8
        $prediction = "The answer will come to you in a dream"
      when 9 
        $prediction = "Soon you will know"
      when 10 
        $prediction = "If you believe so it will be"
    end
  ...
  def say_greeting
    ...
    "\n\n  To play simply type the question wish to ask the Crazy 8-Ball and press enter.\n" +
    "\n  The Crazy 8 ball will provide an answer from the unknown!"+
    "\n\n\n\n\n\n\n\n\n\n\n  Press Enter to " +
               "continue. \n\n: "
    print greeting
  end
  ...
  def get_question
    #This method displays the 8-Ball’s primary query def get_question 
    reply = "" 
